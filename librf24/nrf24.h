...
* @return 1 if the payload was delivered successfully 0 if not
*/
int rf24_write2( const void* buf, uint8_t len );

/**
* Test whether there are bytes available to be read
*
* @return 1 if there is a payload available, 0 if none is
*/
int available(void);
...
*
* @return 1 if the hardware is nRF24L01+ (or compatible) and 0
* if its not.
*/
int isPVariant(void) ;
...
*
* @param enable Whether to enable (1) or disable (0) auto-acks
*/
void setAutoAck(int enable);
...
* @param enable Whether to enable (1) or disable (0) auto-acks
*/
void setAutoAck_pipe( uint8_t pipe, int enable ) ;
...
* @return 1 if the change was successful
*/
...
* @return 1 if the payload was delivered successfully 0 if not
*/
int writeFast2( const void* buf, uint8_t len );
...
*/
int writeFast( const void* buf, uint8_t len, const int multicast );
...
* @return 1 if the payload was loaded into the buffer successfully 0 if not
*/
int writeBlocking( const void* buf, uint8_t len, uint32_t timeout );
...
* @return 1 if transmission is successful
*
*/
int txStandBy();
...
*
*/
int txStandBy_timeout(uint32_t timeout);
...
* @return 1 if there is a payload available, 0 if none is
*/
int available_pipe(uint8_t* pipe_num);
...
* @return 1 if the payload was delivered successfully 0 if not
*/
void startFastWrite( const void* buf, uint8_t len, const int multicast );
...
*
*/
void startWrite( const void* buf, uint8_t len, const int multicast );
...
* a payload is available.  If it returns 1, you must read the packet
* out as the very next interaction with the radio, or the results are
* undefined.
*
* @return 1 if an ack payload is available.
*/
int isAckPayloadAvailable(void);
...
*/
void whatHappened(int *tx_ok,int *tx_fail,int *rx_ready);
...
*
* @return 1 if was carrier, 0 if not
*/
...
*
* @return 1 if signal => -64dBm, 0 if not
*/
int testRPD(void) ;
...
*
* @return 1 if this is a legitimate radio
*/
int isValid(void);
...
*/
void maskIRQ(int tx_ok,int tx_fail,int rx_ready);
